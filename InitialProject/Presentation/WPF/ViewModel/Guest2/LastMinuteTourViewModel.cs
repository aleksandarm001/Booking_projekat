...
{
    class LastMinuteTourViewModel : INotifyPropertyChanged
    {
        ...
        public LastMinuteTourViewModel()
        {
            _tourService = Injector.CreateInstance<ITourService>();
            Cities = new ObservableCollection<string>();
            Countries = new ObservableCollection<string>();
            Tours = new ObservableCollection<Tour>(_tourService.GetAllLastMinuteTours());
